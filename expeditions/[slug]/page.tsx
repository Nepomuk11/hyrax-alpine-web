...
export default function ExpeditionDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="font-sans tracking-tight bg-white min-h-screen">
      ...
      <section className="py-20 bg-white border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-display font-black text-slate-900 mb-8 text-center tracking-tight">
            Höhenprofil
          </h2>
          <div className="relative h-[500px] w-full rounded-2xl overflow-hidden bg-gray-100">
            <Image
